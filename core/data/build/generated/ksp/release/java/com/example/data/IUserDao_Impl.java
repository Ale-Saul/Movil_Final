...
public final class IUserDao_Impl implements IUserDao {
  ...
  private final EntityInsertionAdapter<UserGenreCrossRef> __insertionAdapterOfUserGenreCrossRef;
  ...
  public IUserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `user_table` (`userId`,`username`,`birthDate`,`email`,`password`) VALUES (nullif(?, 0),?,?,?,?)";
      }
    ...
    this.__insertionAdapterOfUserGenreCrossRef = new EntityInsertionAdapter<UserGenreCrossRef>(__db) {
      @Override
      @NonNull
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `UserGenreCrossRef` (`userId`,`genreId`) VALUES (?,?)";
      }

      @Override
      protected void bind(@NonNull final SupportSQLiteStatement statement,
          @NonNull final UserGenreCrossRef entity) {
        statement.bindLong(1, entity.getUserId());
  ...
  @Override
  public Object insertGenre(final Genre genre, final Continuation<? super Unit> $completion) {
  ...
  @Override
  public Object insertUserGenreCrossRef(final UserGenreCrossRef userGenreCrossRef,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __insertionAdapterOfUserGenreCrossRef.insert(userGenreCrossRef);
          __db.setTransactionSuccessful();
          return Unit.INSTANCE;
        } finally {
          __db.endTransaction();
  ...
  @Override
  public Object getGenreIdByName(final String name,
      final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT genreId FROM genre_table WHERE name = ?";
  ...
  public Object loginUser(final String email, final String password,
      final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM user_table WHERE email = ? AND password = ?";
  ...
  @Override
  public Object loginUser2(final String username, final String password,
      final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM user_table WHERE username = ? AND password = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
